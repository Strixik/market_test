<template>
    <div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form autocomplete="off" @submit.prevent="addUser"  ref="add_user">
                    ...
                    <div class="form-group" v-bind:class="{ 'has-error': has_error && errors.password }">
                        ...
                        <input type="password" id="password" name="password" ref="password" class="form-control" v-model="user.password">
